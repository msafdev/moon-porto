...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm text-[#090909] font-[Poppins] font-bold [&+div]:text-xs", className)}
    {...props}
  />
))
